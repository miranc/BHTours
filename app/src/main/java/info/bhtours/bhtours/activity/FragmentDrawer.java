...
import info.bhtours.bhtours.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public List<NavDrawerItem> getData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            navItem.setIcon(getBitmapFromDrawable(icons[i]));
            data.add(navItem);
        }
        return data;
    }

    private Bitmap getBitmapFromDrawable(String drawable)
    {
        Bitmap icon = null;
        Resources res = getActivity().getResources();
        int id = res.getIdentifier(drawable, "drawable", this.getActivity().getPackageName());
        icon = BitmapFactory.decodeResource(getActivity().getResources(), id);
        return icon;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*ImageButton imgBA = (ImageButton) layout.findViewById(R.id.imgBA);
        ImageButton imgUK = (ImageButton) layout.findViewById(R.id.imgUK);
